...
Route::get('/sign-in', function () { return view('intro.auth.signin'); })->name('intro.signin');
// Route::get('/sign-in', function () { return view('auth.login'); })->name('intro.signin');
Route::get('/buyer-signup', function () { return view('intro.auth.buyerSingup'); })->name('intro.buyer-signup');
Route::get('/seller-signup', function () { return view('intro.auth.sellerSignup'); })->name('intro.seller-signup');
...
//social site
Route::get( '/redirect/{service}', 'SocialAuthController@redirect' )->name('social');
...
Route::get('/about-us', function () { return view('intro.about-us'); })->name('intro.aboutUs');
Route::get('/chrome', function () { return view('intro.chrome'); })->name('intro.chrome');
Route::get('/help-buyer', function () { return view('intro.help.buyer'); })->name('intro.faq.buyer');
Route::get('/help-seller', function () { return view('intro.help.seller'); })->name('intro.faq.seller');
Route::get('/contact-us', function () { return view('intro.contact-us'); })->name('intro.faq.contact-us');
Route::get('/testimonials', function () { return view('intro.testimonials'); })->name('intro.testimonials');
Route::get('/buyer-pro', function () { return view('intro.buyer-pro'); })->name('intro.buyer-pro');
Route::get('/seller-pro', function () { return view('intro.seller-pro'); })->name('intro.seller-pro');
Route::get('/term', function () { return view('intro.term'); })->name('intro.term');
Route::get('/privacy', function () { return view('intro.privacy'); })->name('intro.privacy');
...
// Route::get('/forget-password', function () { return view('auth.passwords.email'); })->name('forget_pass');

// Route::post('/forget-password', function () { return view('auth.passwords.email'); })->name('password.update');
...
Route::group(['middleware' => ['web','auth']], function(){
    ...
    Route::get('live-chat', function () { return view('welcome'); } )->name('live-chat');
