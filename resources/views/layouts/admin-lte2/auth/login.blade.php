...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('admin-lte-2/plugins/iCheck/square/blue.css') }}">
...
<script src="{{ asset('admin-lte-2/bower_components/jquery/dist/jquery.min.js') }}"></script>
<script src="{{ asset('admin-lte-2/bower_components/bootstrap/dist/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('admin-lte-2/plugins/iCheck/icheck.min.js') }}"></script>
<script>
  $(function () {
    $('input').iCheck({
