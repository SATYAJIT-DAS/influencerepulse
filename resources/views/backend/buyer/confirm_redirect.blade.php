                            ...
                            <form id="report-key-form" method="post" action="{{route('buyer.order_purchase')}}"
                                ...
                                <div class="form-group fv-has-feedback">
                                    ...
                                    <div class="controls">
                                        ...
                                        <!-- @if($camp->marketplace ==1)
                                        <input class="form-control" type="text" id="key-reported" name="key_reported"
                                            maxlength="100" value=""
                                            data-inputmask-regex="^[a-zA-Z0-9]\d{2}-\d{7}-\d{7}$"
                                            placeholder="Enter the order ID generated by the merchant"
                                            data-fv-field="key_reported">
                                        @else
                                        <input class="form-control" type="number" id="key-reported" name="key_reported"
                                            maxlength="100" value=""
                                            placeholder="Enter the order ID generated by the merchant"
                                            data-fv-field="key_reported">
                                        @endif -->
                            ...
                            fields: {
                                'key_reported': {
                                    validators: {
                                        ...
                                        regexp: {
                                            regexp: /^\w\d{2}-\d{7}-\d{7}$/,
                                            message: 'The Amazon order ID is invalid.',
                                        }
                                    }
                                }
                            }
