                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link active" data-toggle="tab" href="#unread">
                                Unread </a>
                            <a class="nav-link" data-toggle="tab" href="#inbox">
                                Inbox </a>
...
@if($msg->to_user == Auth()->user()->id && ($msg->type ==1 || $msg->type ==2) && $msg->msg_status == 0)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($msg->type ==1)
                                                    {{$msg->getOrder->getCamp->user->name}}
                                                    @else
                                                    <b>Support.team</b>
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary btn-block msg-btn" data-toggle="modal"
                                                        data-target="#generic-modal" data-id="{{$msg->getOrder->id}}" 
                                                        data-to="{{$msg->getOrder->getCamp->user->name}}">
                                                        Message Seller </a>
                                                    <a class="btn btn-dark btn-block"
                                                        href="{{route('buyer.discussion',$msg->getOrder->id)}}">
                                                        View Discussion </a>
                                                    @endif
                                                </td>
                                            </tr>
                            ...
                            <div class="tab-pane fade" id="inbox" role="tabpanel" aria-labelledby="new-tab">
                                <div class="table-responsive-xl">
...
@if($msg->to_user == Auth()->user()->id && ($msg->type ==1 || $msg->type ==2) && $msg->msg_status == 1)
                            ...
                            <div class="tab-pane fade" id="sent" role="tabpanel" aria-labelledby="new-tab">
                                <div class="table-responsive-xl">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php $count=0 ?>
                                            @foreach($msgs as $key => $msg)
                                            @if($msg->user_id == Auth()->user()->id && $msg->type ==0)
                                            <tr>
                                                <?php $count++ ?>
                                                <td>
                                                    {{ date('j F, Y  h:m ', strtotime($msg->date)) }}
