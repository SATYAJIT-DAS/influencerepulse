<header class="navbar navbar-light app-header"><a class="navbar-brand" href="{{route('dashboard')}}">
    ...
    <ul class="nav navbar-nav nav-user right-navbar text-center">
        <!-- <li class="nav-item dropdown px-2">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                ...
                <div class="dropdown-item text-wrap text-muted">
                    <small>
                        <span class="fal fa-info-circle"></span> The maximum number of rebates in 1 day is 5, with a
                        total maximum of 50 in 1 month; however, both rebate maximums are reset each day and each
                        month.
                    </small>
                </div>
        ...
        <li class="nav-item dropdown pr-0">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                </a><a href="{{route('buyer.mail')}}" title="Mailing Address" class="dropdown-item">
                ...
                <a class="dropdown-item" href="{{route('buyer.email')}}" title="Email address">
