...
<main class="main">
    ...
    <div class="container-fluid">
        ...
        <form id="create-campaign-form" method="post" action="{{route('camp_manage.update')}}">
            @csrf
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <label>
                                        Running strategy <i class="fal fa-question-circle" data-toggle="tooltip"
                                            data-placement="top"
                                            title="By default, the campaign will not have a limit of rebates offered. You can pause it at any moment."></i>
                                    </label>
