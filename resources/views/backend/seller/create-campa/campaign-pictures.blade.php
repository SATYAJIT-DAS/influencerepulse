...
<main class="main">
    ...
    <section class="section section-flash aos-init aos-animate" data-aos="flip-up">
        <div class="container-fluid">
            <div class="alert alert-success" role="alert">
                <i class="fal fa-check"></i> {{$update_msg}}</div>
        </div>
    </section>
    @endisset
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <i class="fal fa-image"></i> Campaign Pictures </div>
            <input type="hidden" name="camp" value={{$camp->id}}>

            <div class="card-body">
                <input type="hidden" id="img_count" value="{{count($camp->pic)}}">
                        ...
                        <div class="row">
                            ...
                            <div data-e2e="my-card" class="card-deal col-md-6 col-lg-4 col-xl-3 col-uxxl-2">
                                <div class="deal deal-container deal-item deal-rebate new" data-id="66822"
                                    data-type="rebate">
                                    <div class="row mb-2">
                                        <div class="col-12 pr-0"><a data-id="{{$pic->id}}" onclick="remove_pic({{$pic->id}})"
                                                class="pic-remove badge badge-danger" style="color:white;">Remove</a>
                                        </div>
                                    </div>
                ...
                <div class="container">
                    <form method="post" action="{{route('campic_store', $camp->id)}}" enctype="multipart/form-data"
            ...
            <div class="card-footer">
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        ...
                        <form id="campaign-pictures" method="post" action="{{route('campaign-pic-save')}}">
            ...
            success: function(result) {
                ...
                if (images.length != 0) {
                    $.each(images, function(i) {
                        ...
                        image_tag +=
                            `<div data-e2e='my-card' class='card-deal col-md-6 col-lg-4 col-xl-3 col-uxxl-2'><div class='deal deal-container deal-item deal-rebate new'><div class='row mb-2'><div class='col-12 pr-0'><a  onclick="remove_pic(`+images[i].id+`)" class='pic-remove badge badge-danger' style='color:white;'   >Remove</a></div></div><a  class='preview'><img src="`;
    ...
    Dropzone.options.dropzone = {
        ...
        success: function(file, response) {
            state_msg = "";
            state_msg =
                "<section class='section section-flash aos-init aos-animate' data-aos='flip-up'><div class='container-fluid'><div class='alert alert-success' role='alert'><i class='fal fa-check'></i> Your campaign has been updated.</div></div></section>";
            image_tag = "";
            ...
            if(images.length > 0){
                ...
                $.each(images, function(i) {
                    img_path = 'public/images/' + images[i].image_path;
                    image_tag +=
                        `<div data-e2e='my-card' class='card-deal col-md-6 col-lg-4 col-xl-3 col-uxxl-2'><div class='deal deal-container deal-item deal-rebate new'><div class='row mb-2'><div class='col-12 pr-0'><a  onclick="remove_pic(`+images[i].id+`)"  class='pic-remove badge badge-danger' style='color:white;'>Remove</a></div></div><a href="" class='preview'><img src="`;
                    image_tag += `{{asset('` + img_path + `')}}`;
