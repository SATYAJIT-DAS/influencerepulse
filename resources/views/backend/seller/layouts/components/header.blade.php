<header class="navbar navbar-light app-header">
    <a class="navbar-brand" href="{{route('dashboard')}}">
        <img src="{{asset('intro/img/logo.png')}}" alt="influencerpulse" style="width: 11rem !important" class="img-fluid">
    </a>
    <ul class="nav navbar-nav navbar-main-menu text-center justify-content-center flex-grow-2">
        ...
        <li class="nav-item d-md-down-none">
            <a class="nav-link disabled" href="{{route('seller.faq')}}" disabled>
                FAQ
            </a>
        </li>
        <li class="nav-item d-md-down-none">
            <a class="nav-link text-blue" href="" data-toggle="modal" data-target="#generic-modal">
                Notifications
            </a>
        </li>
        <li class="nav-item d-md-down-none">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        Receive live notifications into your browser even if you are not online on INFLUENCER PULSE. </p>

                    <div class="alert alert-info">

                        <p>
                            <i class="fal fa-info-circle"></i>
                            We will notify you for any important event related to your INFLUENCER PULSE account: </p>
                        <ul>
                            <li>
                                Deals campaigns online/offline </li>
                            <li>
                                Order Id keys approval </li>
                            <li>
