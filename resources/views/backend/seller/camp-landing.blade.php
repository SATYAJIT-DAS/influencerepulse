            ...
            <div class="row">
                ...
                <div class="col-xxl-10 col-lg-11 mx-auto pb-3">
                        ...
                        <div class="prod-description col pl-xl-3">
                            ...
                            {{--<div class="mb-2-5"><small class="d-block">
                                    ...
                                    <i class="fal fa-fw fa-folder-tree"></i> Get more Rebates up to 100% for <a
                                        href="https://influencerpulse.com/rebates/toys-games">Toys & Games</a>
                                </small>
                            </div>--}}
                            <div class="mt-4">
                                ...
                                <a style="color:white;" href="{{route('dashboard')}}" class="btn btn-primary btn-block mb-2-5 py-1" id="camp-url">
                                    Buy Product
                                </a>
                    ...
                    <p class="text-center text-muted mt-3 mb-0 mx-1 mx-xxl-10">
                        <small>
                            Note: You have to register with <a href="{{route('intro.home')}}">influencerpulse.com</a>
        ...
        <div class="container-fluid py-xl-10 py-6">
            ...
            <div class="row mt-5">
                ...
                <div data-e2e="my-card" class="card-deal col-md-6 col-lg-4 col-xl-3 col-uxxl-2">
                    <div class="deal deal-container deal-item ">
                        <div class="row mb-2">
                            ...
                            <div class="col-2 pl-0">
                                <div class="deal-actions">
                                    <div class="share">
                                        <i class="fal fa-share-alt fa-fw"
                                             aria-expanded="false"
                                            aria-controls="share-67715" ></i>
                        ...
                        <a href="{{route('seller.camp-landing',$camp->id)}}"
                            class="preview">
                            @if($camp->pic[0])
