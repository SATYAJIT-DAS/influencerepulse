...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('seller.msg')}}">Messages</a></li>
        <li class="breadcrumb-item active">Discussion about rebate #{{$order->id}} with {{$order->getBuyer->name}}</li>
    </ol>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header align-items-center">
                        ...
                        <h5 class="modal-title">Write a message to {{$order->getBuyer->name}}</h5>
