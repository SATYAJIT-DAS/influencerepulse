        ...
        <div class="container py-xl-20 py-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-10 mx-auto mx-xl-0 text-center text-xl-left mt-0 d-flex px-2 px-sm-0">
                    <div class="m-auto">
                        <h1 class="mb-3 text-white">influencerpulse Buyer Affiliate Program</h1>
                        <p class="mb-3 text-white lato-medium">
                            Earn like a boss as our affiliate! </p>
                        <p class="font-italic text-white italic-main-text mb-5">
                            If you’re blogger, youtuber or simply have a lot of social presence, join our Affiliate
                            Program today and turn our awesome rebates into your income. </p>
                        <a data-scroll href="#buyer-sign-up-form" class="btn btn-primary px-xl-9 mb-0 smooth-scroll">
        ...
        <div class="container mb-xl-9 mb-4">
            ...
            <div class="row align-items-center">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                            <p>
                                ...
                                It's easy and free to join. </p>
                        </li>
                        <li>
                            <p>
                                <i class="sprite-icon-li-check mr-1"></i>
                                As your referrals get rebates, you get credited. </p>
                        </li>
                        <li>
                            <p>
                                <i class="sprite-icon-li-check mr-1"></i>
                                The more rebates they get, the higher your commission gets: </p>
                        ...
                        <li>
                            <p>
                                <i class="sprite-icon-li-check mr-1"></i>
                                Our cookie based tracking software allows affiliates to be credited up to 30 days after
                                the first click. </p>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-6 offset-lg-1 mb-3 mb-lg-0">
                    <img src="intro/img/affiliate3.jpg" class="img-fluid"
                        alt="Buyer Affiliate Program">
                </div>
        ...
        <div class="container py-xl-10 py-6 dollar-bg">
            ...
            <div class="col-xl-6 mx-auto">
                ...
                <h3 class="mb-6 text-center">
                    So, what are you waiting for? Enroll now, it is FREE! </h3>


                <form id="buyer-sign-up-form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <div id="input-group-phone" class="input-group input-group-shadow" data-toggle="tooltip"
                                data-trigger="focus" data-container="#input-group-phone"
                                title="Your phone number is only required to verify your identity. It won't be transferred to third parties or used for marketing by influencerpulse.">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">+1</span>
                                </div>
                                <input class="form-control" id="phone" name="phone" maxlength="10" value=""
                                    placeholder="Cell phone" type="number">
                            </div>
                        </div>
                    </div>
                    ...
                    <p class="mt-4 text-center small-text mb-0 px-3">
                        By signing up, you agree to our <a href="../../legal/terms.html" target="_blank">Terms of
                            Service</a>, <a href="../../legal/privacy.html" target="_blank">Privacy Policy</a> and to
                        receive influencerpulse emails, newsletters & updates. This site is protected by reCAPTCHA and the
                        Google <a href="https://policies.google.com/terms" target="_blank">Terms of Service</a> and <a
                            href="https://policies.google.com/privacy" target="_blank">Privacy Policy</a> apply. </p>
