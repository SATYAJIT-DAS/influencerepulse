    ...
    <section class="gradient-bg">
        ...
        <div class="container py-lg-10 py-5">
            ...
            <ul class="nav nav-tabs mx-1 mx-sm-0 faq-tabs nav-fill" id="faq-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link nav-link-buyer roboto-medium py-1 active" id="buyer-tab"
                        href="{{route('intro.faq.buyer')}}" role="tab" aria-controls="buyer"
            ...
            <div class="tab-content mx-1 mx-sm-0 p-2-5 faq-tab-content" id="faq-content">
                ...
                <div class="tab-pane fade show active p-0" id="seller" role="tabpanel" aria-labelledby="seller-tab">

                    <div id="seller-accordion" class="nice-accordion faq-accordion" role="tablist">

                        <div class="card">
                            <div class="card-header" role="tab" id="seller-heading-15">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" href="#seller-collapse-15" aria-expanded="true"
                                        aria-controls="seller-collapse-15"
                                        class="roboto-medium mb-0 d-flex justify-content-between align-items-center">
                                        <span>Wanted to list products on site</span>
                                        <span class="accordion-caret"></span>
                                    </a>
                                </h5>
                            </div>

                            <div id="seller-collapse-15" class="collapse show" role="tabpanel"
                                aria-labelledby="seller-heading-15" data-parent="#seller-accordion">
                                <div class="card-body">
                                    Thank you for your interest in our service. To list your products, you need to <a
                                        href="../../seller/sign-up.html">sign up</a> as a seller. Once done, you will
                                    then be
                                    presented with instructions on how to do so.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-1" class="collapse" role="tabpanel"
                                aria-labelledby="seller-heading-1" data-parent="#seller-accordion">
                                <div class="card-body">
                                    Whether you are launching a new product or accelerating the sales for an old one,
                                    you need the sales and
                                    you need the buzz. influencerpulse gives you just that. Giving rebates is the best way to
                                    get attention of the
                                    new buyers and these buyers are more likely to spread the word about your product.
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="seller-collapse-16" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    <p>Our site is built to help you get full priced sales using rebates instead of
                                        coupons. Full priced
                                        sales can help you rank faster than discounted sales. But please note that <b>we
                                            are not a review
                                    ...
                                    <p>With our platform, you can enter any URL you want to send the buyers to claim
                                        ...
                                        will enter their order ID into our system to start the rebate process. You will
                                        also be able to
                                        communicate with buyers using our buyer/seller messaging to help them with the
                                        process or answer
                                        questions.</p>

                                    <p>We also provide landing pages for you to drive your own traffic in order to get
                                        more claims per
                                        day.</p>
                                    ...
                                    <p>After the buyer enters their order number and the money is held for 30 days after
                                        that you’ll have a
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-2" class="collapse" role="tabpanel"
                                aria-labelledby="seller-heading-2" data-parent="#seller-accordion">
                                <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-3" class="collapse" role="tabpanel"
                                aria-labelledby="seller-heading-3" data-parent="#seller-accordion">
                                <div class="card-body">
                                    A Rebate Key is a unique number, e.g. Order ID that the buyer will provide to you to
                                    unlock the rebate.
                                    You can either approve it (if it matches with your sales data), or deny it (if there
                                    is no such order).
                                    We warn you from abuse (e.g. denying many rebates without checking). We will flag
                                    such activity.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-4" class="collapse" role="tabpanel"
                                aria-labelledby="seller-heading-4" data-parent="#seller-accordion">
                                <div class="card-body">
                                    You can give a rebate of as low as 10% and as high as 100%. Up to you. Obviously the
                                    higher the rebate
                                    the more likely the customers will claim it, and more likely to actively participate
                                    in your viral
                                    marketing campaign.
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-5" class="collapse" role="tabpanel"
                                aria-labelledby="seller-heading-5" data-parent="#seller-accordion">
                                <div class="card-body">
                                    It depends on your marketing goals. If you are giving a boost to your new product,
                                    10-20/day is a good
                                ...
                                <div class="card-body">
                                    ...
                                    <ul>
                                        ...
                                        <li>A <b>general wallet</b> (you can consult your general wallet here: <a
                                                href=""
                                                target="_blank">https:///seller/wallet.html</a>).
                                        </li>
                                    </ul>
                                    <p>When you create/edit a rebate campaign, payments are <b>credited into the rebate
                                            campaign wallet</b>.
                                        To consult the wallet of each rebate, go to your list of rebate campaigns (<a
                                            href=""
                                            target="_blank">https:///rebates.html</a>). On the right
                                        part of each rebate campaign, click on the dark "Details" button and click on
                                        "View wallet".</p>
                                    <p>When your rebate campaign ends (or if you cancel it), the system automatically
                                        will first check how
                                        many claims you had for that rebate campaign. According to the number of claims
                                        you got, the system
                                        will block the corresponding amount of money in your <b>rebate wallet</b> to pay
                                        out buyers.</p>
                                    <p>The <b>remaining money</b> for that rebate campaign is automatically
                                        <b>transferred to your general
                                            wallet</b>. For your new rebate campaigns, you will be able to pay with your
                                        general wallet.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-6" class="collapse" role="tabpanel"
                                aria-labelledby="seller-heading-6" data-parent="#seller-accordion">
                                <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-7" class="collapse" role="tabpanel"
                                aria-labelledby="seller-heading-7" data-parent="#seller-accordion">
                                <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-8" class="collapse" role="tabpanel"
                                aria-labelledby="seller-heading-8" data-parent="#seller-accordion">
                                <div class="card-body">
                                    We support any e-commerce platform, e.g. shopify sites, Walmart, Amazon and jet.com
                                    listings. We will
                                    verify each link.
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="seller-heading-25">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" href="#seller-collapse-25" aria-expanded="false"
                                        ...
                                        class="roboto-medium mb-0 d-flex justify-content-between align-items-center collapsed">
                                        <span>I just finished setting up my campaign, but the credit card I am paying
                                            with was declined</span>
                                        <span class="accordion-caret"></span>
                                    </a>
                                </h5>
                            </div>
                            <div id="seller-collapse-25" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    Please note that Stripe doesn't require personal information to proceed or not to
                                    the payment. They use
                                    their own security algorithm to validate credit/debit cards. Sometimes they can mark
                                    multiple payment
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-19" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    To cancel your campaign, just click on "Campaigns" in your Profile. On the “Actions”
                                    button next to the
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-28" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    There's no limit of campaigns as long as there are from different products. There
                                    can be only ONE
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-29" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    ...
                                    result in a discrepancy on the funds sent by check and the actual price users paid.
                                    <b>Rebate check
                            ...
                            <div class="card-header" role="tab" id="seller-heading-26">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" href="#seller-collapse-26" aria-expanded="false"
                                        ...
                                        class="roboto-medium mb-0 d-flex justify-content-between align-items-center collapsed">
                                        <span>I'd like to change the card I have on file. Is there a way I could change
                                            this billing information?</span>
                                        <span class="accordion-caret"></span>
                                    </a>
                                </h5>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-9" class="collapse" role="tabpanel"
                                aria-labelledby="seller-heading-9" data-parent="#seller-accordion">
                                <div class="card-body">
                                    You can get a refund only at the end of the campaign for the unclaimed rebates.
                                    Since buyers actually go
                                    and buy your product, you can not get a refund for claimed and verified purchases.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-17" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    Yes. Every day at 01:00 am EST, we transfer money from canceled/completed campaigns
                                    to the
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-18" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    <p>We’re very sorry to hear that. While our site is great for certain items, it's
                                        important to remember
                                        that customers have to pay the full price and wait for their rebate. What we
                                        suggest sellers to
                                        increase claims is to drive their own buyer traffic to their landing pages. This
                                        is a great way to
                                        do it, a different one would be offering a 100% rebate!</p>

                                    <p class="mb-0">When your campaign is over, you can request the refund back to your
                                        card.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="seller-collapse-24" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    You can use the funds in another campaign or request a refund in the <a
                                        href="../../user/sign-ine9c0.html">general wallet</a>.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-10" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    <p>Yes. Each time a buyer claims a rebate, you will be given his Order ID for you to
                                        approve or dispute.
                                        Please check carefully. Sellers who dispute too many rebates will be flagged.
                                    </p>

                                    <p>The determination of a Rebate dispute should be based on the compliance of one or
                                        more of the
                                        following reasons:</p>
                                    ...
                                    <ul>
                                        ...
                                        <li>Extra discount coupons or codes were used along with the Rebate Key offer.
                                        </li>
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-21" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    ...
                                    <ol class="mb-0">
                                        <li>Put that number/ buyer name somewhere you'll remember, like a note on your
                                            phone/computer/draft
                                            on your email.
                                        </li>
                                        <li>Let the buyer know (through our messaging system) that his/her rebate will
                                            be declined due to
                                        ...
                                        <li>Decline that buyer's purchase on a 5-day window before the system approves
                                            them automatically.
                                        </li>
                                    </ol>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="seller-heading-23">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" href="#seller-collapse-23" aria-expanded="false"
                                        ...
                                        class="roboto-medium mb-0 d-flex justify-content-between align-items-center collapsed">
                                        <span>Do I get the buyer’s emails so that I can follow up for feedback?</span>
                                        <span class="accordion-caret"></span>
                                    </a>
                                </h5>
                            </div>
                            <div id="seller-collapse-23" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    No, you don’t. However, you go to Rebate Queue > Recent Claims > Message Buyer and
                                    follow up there.
                                    Please keep in mind that you can only contact them for 60 days after the purchase.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div id="seller-collapse-14" class="collapse" role="tabpanel"
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="../../company/contact-us.html">contact us</a>.<br />
                                    If you have any live rebates, there have to be completed before you cancel or delete
                                    your account.
                                </div>
                            </div>
                        </div>
