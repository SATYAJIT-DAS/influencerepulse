...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $camps = Campaign::where('permission', 'online')->where('private_status', 0)->orderby('updated_at', 'DESC')->get();
